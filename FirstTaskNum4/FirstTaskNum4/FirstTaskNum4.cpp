...
/// Организуйте ввод последовательности чисел с клавиатуры и найдите:
/// а) сумму всех введённых чисел;
/// б) сумму положительных чисел;
/// в) максимум среди отрицательных чисел.
/// Работа программы завершается, когда с клавиатуры будет ведён символ ‘*’.
/// Используйте возможности системы программирования для предотвращения ошибок,
/// связанных с вводом недопустимых значений и выходом за границы допустимых
/// диапазонов значений при вычислениях.
