...
/// Написать программу, которая выводит на экран максимальное/минимальное из значений 
/// элементов целочисленного массива, содержащего 15 элементов.
...
int* inputMas() // Ввод массива
{
	...
	for (int i = 0; i < 15; i++)
	{
		cout << "Введите " << i + 1 << "-й из 15-и элементов массива: ";
		cin >> mas[i];
		cout << endl;
	}
